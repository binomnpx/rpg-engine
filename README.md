This is my [RPG](https://en.wikipedia.org/wiki/Role-playing_game) passion project made real. It is entirely written in Lua and is designed for the [PICO-8](https://www.lexaloffle.com/pico-8.php) fantasy console.
...
What you see is the result of a fully fleshed out entity-component-system architecture, some painstaking art made by yours truly, and some procedural generation that populates the world. Some objects even "talk" to each other in the code. This game programming pattern makes debugging and feature creep more manageable!
